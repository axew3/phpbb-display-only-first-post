...
class acp_controller
{
  ...
  $POST_data = $this->request->variable('w3all_displayonlyfirstpost', ['' => '']); // $POST_data['u_groups']
      ...
      if (empty($errors))
      {
        ...
        $POST_data = json_encode($POST_data,  JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_NUMERIC_CHECK);
    ...
    if(empty($dbd)){
     $dbd = array();
     //$dbd['w3all_displayonlyfirstpost']['u_groups'] = $dbd['w3all_displayonlyfirstpost']['forums_ids'] = $dbd['w3all_displayonlyfirstpost']['rep_mode'] = $dbd['w3all_displayonlyfirstpost']['rep_content'] = '';
    ...
    $this->template->assign_vars([
      ...
      //'W3ALL_DISPLAYONLYFIRSTPOST_REP_CONTENT' => $dbd['w3all_displayonlyfirstpost']['rep_content'],      
    ]);
  }
