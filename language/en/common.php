...
$lang = array_merge($lang, [
  ...
  'DISPLAYONLYFIRSTPOST_EVENT_REPLACEMENT_TEXT'   => '<h2><p class="error">You can only view the first post into this topic.<br />Please register or join the memberships allowed to view all the replies!</p></h2>',

  'ACP_DISPLAYONLYFIRSTPOST_GROUPS_IDS'     => 'Users GroupIDs (separate by comma) that will see only the first post',
  'ACP_DISPLAYONLYFIRSTPOST_FORUMS_IDS'     => 'ForumIDs (separate by comma) of forums in which only the topic start post can be read.<br />If you wish to show only the first post in all forums at once, enter the word <i style="color:red"><b>all</b></i> as value',
